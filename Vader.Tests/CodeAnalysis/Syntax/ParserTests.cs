...
namespace Vader.Tests.CodeAnalysis.Syntax
{
    public class ParserTests
    {
        ...
        public void Parser_BinaryExpression_HornorPrecedences(SyntaxKind op1, SyntaxKind op2)
        {
        ...
        public void Parser_UnaryExpression_HornorPrecedences(SyntaxKind unaryKind, SyntaxKind binaryKind)
        {
