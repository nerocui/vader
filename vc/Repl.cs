    ...
    internal abstract class Repl
    {
        ...
        internal sealed class SubmissionView
        {
            ...
            private void Render()
            {
                ...
                if (numberOfBlankLine > 0)
                {
                    var blandLine = new string(' ', Console.WindowWidth);
                    for (var i = 0; i < numberOfBlankLine; i++)
                    {
                        Console.SetCursorPosition(0, _cursorTop + lineCount + i);
                        Console.WriteLine(blandLine);
                    }
                }
        ...
        private void HandleBackSpace(ObservableCollection<string> document, SubmissionView view)
        {
            ...
            if (start == 0)
            {
                ...
                var previoudLine = document[view.CurrentLine - 1];
